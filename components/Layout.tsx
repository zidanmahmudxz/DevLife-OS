...
const Icons = {
  ...
  Finance: ({ active }: { active: boolean }) => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="12" cy="12" r="9" fill={active ? "url(#grad-emerald)" : "currentColor"} fillOpacity={active ? "1" : "0.2"} stroke={active ? "#10b981" : "currentColor"} strokeWidth="1.5"/>
      <path d="M12 7V17M12 7C10.5 7 9 8.5 9 10C9 11.5 10.5 13 12 13M12 13L15 17" stroke={active ? "#ecfdf5" : "currentColor"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M10 7H14" stroke={active ? "#ecfdf5" : "currentColor"} strokeWidth="1.5" strokeLinecap="round"/>
      <defs>
        <linearGradient id="grad-emerald" x1="3" y1="3" x2="21" y2="21" gradientUnits="userSpaceOnUse">
