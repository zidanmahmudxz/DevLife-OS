...
export const ApiVault: React.FC<ApiVaultProps> = ({ vault }) => {
  ...
  // ✅ FIXED: Proper UUID for Supabase compatibility
    ...
    <div className="max-w-4xl mx-auto space-y-8">
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-slate-400">
            Locally encrypted keys. They sync securely to your account.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-4">
        {vault.map((entry) => (
          <div
            key={entry.id}
            className="glass p-5 rounded-2xl flex items-center justify-between group hover:border-indigo-500/30 transition-all"
          >
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={() =>
                    handleReveal(entry.id, entry.encrypted_key)
                  }
